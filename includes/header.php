<?php 
    ...
    session_start();
    define("APPURL","http://localhost/freshvery");
    
    define("IMGURLCATEGORY", "http://localhost/freshvery/admin-panel/categories-admins/img_category");
    define("IMGURLPRODUCT", "http://localhost/freshvery/admin-panel/products-admins/img_product");
//name faile
...
<html>
<head>
    <title>freshvery | Épicerie Magasin bio</title>
    <meta charset="utf-8">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarcollapse">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a href="<?php echo APPURL;?>/shop.php" class="nav-link">ACHETEZ</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <?php if(!isset($_SESSION['username'])) : ?>
                            <li class="nav-item">
                                <a href="<?php echo APPURL;?>/auth/register.php" class="nav-link">Enregistrer</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo APPURL;?>/auth/login.php" class="nav-link">Connexion</a>
                            </li>
                        <?php else : ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="<?php echo APPURL;?>/users/transaction.php?id=<?php echo $_SESSION['user_id']; ?>">Historique des transactions</a>
                                    <a class="dropdown-item" href="<?php echo APPURL;?>/users/setting.php?id=<?php echo $_SESSION['user_id']; ?>">Paramètres</a>
                                    <a class="dropdown-item" href="<?php echo APPURL;?>/auth/logout.php">Se déconnecter</a>
                                </div>
                            </li>
                            <li class="nav-item">
