                    ...
                    <div class="row mt-3">
                        <div class="col-lg-7">
                            <div class="contact-wrapper">
                                <h3 class="title font-weight-normal mt-0 text-left">Envoie-nous un message</h3>
                        ...
                        <div class="col-lg-5">
                            <div class="detail-wrapper p-5 bg-primary">
                                ...
                                Siège social de Freshcery
                                </h3>

                                <p class="text-light">
                                    Fes. Agriculteur n° 365, Cibabat<br>
                                    Fes Nord<br>
                                    Ville de Fes<br>
                                    Java occidental 40513
                                </p>

                                <p class="text-light">
                                    <i class="fas fa-phone"></i> 0680478222<br>
                                    <i class="fas fa-envelope"></i> omarelbzizi9@freshcery.com
                                </p>
                            </div>
                        </div>
                    </div>
